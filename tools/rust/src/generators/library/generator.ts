...
import { addBuildExecutor, addLintExecutor, addTestExecutor } from "../../utils/add-executors";
...
function addFiles(tree: Tree, options: NormalizedSchema & RustLibraryGeneratorSchema) {
