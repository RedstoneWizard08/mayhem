...
function addFiles(tree: Tree, options: NormalizedSchema & RustBinaryGeneratorSchema) {
...
export default async function binaryGenerator(tree: Tree, options: RustBinaryGeneratorSchema) {
    await init(tree);
