...
import { JOIN_SERVER, LEAVE_SERVER, DELETE_SERVER } from "./keys";
...
export const deleteServer = (server: number, ws: WebSocket): Promise<boolean> => {
    return serverOnlyAction(DELETE_SERVER, server, ws);
};
